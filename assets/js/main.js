    ...
    if (isFallout.toLowerCase() == 'y') {
        ...
        if (docsPending == 'y' && docsReceived == 'n' && claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                document.getElementById('claim-msg-text').innerHTML = ' <div> <h3>YOUR REQUEST IS BEING PROCESSED</h3> <br /> <p class="font-weight-justy request-font"> Hang in there as we are now processing your request. Kindly expect an SMS update from us within 7 to 10 working days on the status of your request. </p> <br /> <p class="font-weight-normal request-font"> If we would need additional documents to support your request, we will reach out to you immediately. </p> <br /> <p class="font-weight-normal request-font"> You may also check the progress of your request <a href="https://aporve.github.io/phase2-pal-staging/main">here</a>. Just type in your reference number ' + transactionNumber + ' to view the status of your request. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "block";
                document.getElementById("payment-ref").style.display = "none";
                twoStepperActive();
            }
            else if (claimStatus.toLowerCase() == 'approved') {
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>YOUR PAYOUT HAS BEEN APPROVED</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + '. We would like to let you know that we have approved your claim request for your AIA Philippines policy. </p> <br /> <p class="font-weight-normal request-font"> Kindly expect to receive your claim benefits  through your chosen payout method. Please expect an update from us on when your benefit will be released. </p> <br /> <p class="font-weight-normal request-font"> We have also sent this information via SMS for your reference. </p> </div>'
        ...
        if (docsPending == 'y' && docsReceived == 'n' && claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                document.getElementById('claim-msg-text').innerHTML = ' <div> <h3>YOUR REQUEST IS BEING PROCESSED</h3> <br /> <p class="font-weight-justy request-font">Hi ' + claimantFirstName + ' . Hang in there as we are now processing your request. Kindly expect an SMS update from us within 7 to 10 working days on the status of your request. </p> <br /> <p class="font-weight-normal request-font"> If we would need additional documents to support your request, we will reach out to you immediately. </p> <br /> <p class="font-weight-normal request-font"> You may also check the progress of your request <a href="https://aporve.github.io/phase2-pal-staging/main">here</a>. Just type in your reference number ' + transactionNumber + ' to view the status of your request. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "block";
                document.getElementById("payment-ref").style.display = "none";
                twoStepperActive();
            }
            else if (claimStatus.toLowerCase() == 'approved') {
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>YOUR PAYOUT HAS BEEN APPROVED</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + '. We are glad to let you know that we have approved your claim request for your AIA Philippines policy no. ' + policyNumber + '. </p> <br /> <p class="font-weight-normal request-font"> Kindly expect to receive ' + currency + ' ' + claimAmount + ' through your chosen payout method. Please expect an update from us on when your benefit will be released. </p> <br /> <p class="font-weight-normal request-font"> We have also sent this information via SMS for your reference. </p> </div>'
                ...
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"><p> Sorry, there seems to be a problem.</p> <br /> Hi ' + claimantFirstName + '. We have reviewed the documents you submitted and we regret to inform you that we are unable to grant your claim request right now. There seems to be a problem as your AIA Philippines policy does not cover the condition for which you are claiming a benefit. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + '. Please let us know if you wish to discuss this in detail so we can assist in providing you alternative options. </p> <br /> <p class="font-weight-normal request-font"> While we can’t release a payment for this claim, we can assure you that your life insurance coverage remains intact for the future. </p> <br/>  <p class="font-weight-normal request-font"> If you have any questions, you may reach out to us by chatting Aya of AIA Philippines on Facebook Messenger or sending us an e-mail at customerservice.ph@aia.com. You may also call us at our Customer Hotline at (02)8528-2000. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "none";
                document.getElementById("payment-ref").style.display = "none";
                allStepperActive()
            }
            else if (claimStatus.toLowerCase() == 'denied3') {
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"><p> Sorry, there seems to be a problem.</p><br /> Hi ' + claimantFirstName + '.We have reviewed the documents you submitted, and we regret to inform you that we are unable to grant your claim request right now. There seems to be a problem as the circumstances that led to your current condition are not included in the provisions of your AIA Philippines policy. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + '. Please let us know if you wish to discuss this in detail so we can assist in providing you alternative options. </p> <br /> <p class="font-weight-normal request-font"> While we can’t release a payment for this claim, we can assure you that your life insurance coverage remains intact for the future. </p> <br /> <p class="font-weight-normal request-font"> If you have any questions, you may reach out to us by chatting Aya of AIA Philippines on Facebook Messenger or sending us an e-mail at customerservice.ph@aia.com. You may also call us at our Customer Hotline at (02)8528-2000. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "none";
                document.getElementById("payment-ref").style.display = "none";
                allStepperActive()
            }
            else if (claimStatus.toLowerCase() == 'denied4') {
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"><p> Sorry, there seems to be a problem.</p><br /> Hi ' + claimantFirstName + '. We have reviewed the documents you submitted and we regret to inform you that we are unable to grant your claim request right now. There seems to be a problem as your coverage and all its benefits have ended last ' + lapsationDate + ' due to non-payment of premium dues. </p> <br /> <p class="font-weight-normal request-font"> We’re sorry for this news, ' + claimantFirstName + ', and we continue to wish you a speedy recovery. Please let us know if you wish to discuss this in detail so we can assist in providing you alternative options. </p> <br /> <p class="font-weight-normal request-font"> If you have any questions or concerns regarding this matter, or you’d like to know how we can reinstate your policy, you may reach out to us by chatting Aya of AIA Philippines Life on Facebook Messenger or sending us an e-mail at customerservice.ph@aia.com. You may also call us at our Customer Hotline at (02)8528-2000. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "none";
                document.getElementById("payment-ref").style.display = "none";
                allStepperActive()
            }
    ...
    if (isFallout.toLowerCase() == 'y') {
        ...
        if (docsPending == 'y' && docsReceived == 'n'&& claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                ...
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + ' . We hope that you are on your way to a speedy recovery. However, we have reviewed the documents you submitted and we regret to inform you that we are unable to grant your claim request right now as the circumstances that led to your current condition are not included in the provisions of your AIA Philippines policy. Please let us know if you wish to discuss this in detail. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + ' , and while we can’t release a payment for this claim, we can assure you that your life insurance coverage remains intact for the future. </p> <br /> <p class="font-weight-normal request-font"> If you have any questions, you may reach out to us by chatting Aya of AIA Philippines on Facebook Messenger or sending us an e-mail atcustomerservice.ph@aia.com.. You may also call us at our Customer Hotline at (02)8528-2000. </p> </div>'
                document.getElementById("turnaround-time-ref").style.display = "none";
                document.getElementById("payment-ref").style.display = "none";
                allStepperActive()
            }
        ...
        if (docsPending == 'y' && docsReceived == 'n' && claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                ...
                document.getElementById('claim-msg-text').innerHTML = '<div> <h3>YOUR PAYOUT HAS BEEN APPROVED</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + '. We are glad to let you know that we have approved your claim request for your AIA Philippine policy no. ' + policyNumber + '. </p> <br /> <p class="font-weight-normal request-font"> Kindly expect to receive ' + currency + ' ' + claimAmount + ' through your chosen payout method. Please expect an update from us on when your benefit will be released. </p> <br /> <p class="font-weight-normal request-font"> We have also sent this information via SMS for your reference. </p> </div>'
    ...
    if (isFallout.toLowerCase() == 'y') {
        ...
        if (docsPending == 'y' && docsReceived == 'n' && claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                ...
                if(claimantFirstName !== ''){
                    document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br />  <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + ', first of all, we would like to extend our deepest sympathies for your loss. However, after reviewing the documents you submitted, we regret to inform you that we are unable to grant your claim request right now. </p> <br /> <p class="font-weight-normal request-font"> Upon checking, your coverage and all its benefits have ended due to non-payment of premium dues. Please let us know if you wish to discuss this in detail so we can assist how you may be able to reinstate your policy so you can enjoy continued protection. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + '. If you have any questions or concerns regarding this matter, you may chat with Aya of  AIA Philippines on Facebook Messenger or Viber. You may also contact or customer hotline at (02)8528-2000. </p> </div>'
                    document.getElementById("turnaround-time-ref").style.display = "none";
                    document.getElementById("payment-ref").style.display = "none";
                    allStepperActive()
                }else {
        ...
        if (docsPending == 'y' && docsReceived == 'n' && claimStatus == 'received') {
            ...
            if (claimStatus.toLowerCase() == 'received') {
                ...
                if (beneficiaryCount == 1) {
                    ...
                    if( claimantFirstName !== '') {
                        document.getElementById('claim-msg-text').innerHTML = '<div> <h3>YOUR PAYOUT HAS BEEN APPROVED</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + '. We would like to let you know that we have approved your claim request for your AIA Philippines policy no. ' + policyNumber + '  for ' + beneficiaryCount + ' beneficiary/ies. </p> <br /> <p class="font-weight-normal request-font"> Kindly expect to receive the benefit through your chosen payout method. Please expect an update from us on when your benefit will be released. </p> <br /> <p class="font-weight-normal request-font"> We have also sent this information via SMS for your reference. </p> </div>'
                        document.getElementById("turnaround-time-ref").style.display = "none";
                        document.getElementById("payment-ref").style.display = "none";
                    }else {
                        document.getElementById('claim-msg-text').innerHTML = '<div> <h3>YOUR PAYOUT HAS BEEN APPROVED</h3> <br /> <p class="font-weight-justy request-font"> We would like to let you know that we have approved your claim request for your AIA Philippines policy no. ' + policyNumber + '  for ' + beneficiaryCount + ' beneficiary/ies. </p> <br /> <p class="font-weight-normal request-font"> Kindly expect to receive the benefit through your chosen payout method. Please expect an update from us on when your benefit will be released. </p> <br /> <p class="font-weight-normal request-font"> We have also sent this information via SMS for your reference. </p> </div>'
                ...
                if(claimantFirstName !== ''){
                    document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + ', first of all, we would like to extend our deepest sympathies for your loss. However, after reviewing the documents you submitted, we regret to inform you that we are unable to grant your claim request right now. There seems to be a problem as your policy doesn’t have <Type of Claim> coverage. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + '. Please let us know if you wish to discuss this in detail so we can assist in providing you alternative options. You may reach us through our Customer Hotline at (02)8528-2000 or you may discuss your concern with your financial advisor. </p> <br /> <p class="font-weight-normal request-font"> If you have other questions, you may reach out to us by chatting Aya of AIA Philippines on Facebook Messenger or sending us an e-mail at customerservice.ph@aia.com. </p> </div>';
                    document.getElementById("payment-ref").style.display = "none";
                    allStepperActive()
                }else {
                    document.getElementById('claim-msg-text').innerHTML = '<div> <h3>AN UPDATE ON YOUR CLAIM REQUEST</h3> <br /> <p class="font-weight-justy request-font"> Hi ' + claimantFirstName + ', first of all, we would like to extend our deepest sympathies for your loss. However, after reviewing the documents you submitted, we regret to inform you that we are unable to grant your claim request right now. There seems to be a problem as your policy doesn’t have <Type of Claim> coverage. </p> <br /> <p class="font-weight-normal request-font"> We understand that you’re going through a tough time, ' + claimantFirstName + '. Please let us know if you wish to discuss this in detail so we can assist in providing you alternative options. You may reach us through our Customer Hotline at (02)8528-2000 or you may discuss your concern with your financial advisor. </p> <br /> <p class="font-weight-normal request-font"> If you have other questions, you may reach out to us by chatting Aya of AIA Philippines on Facebook Messenger or sending us an e-mail at customerservice.ph@aia.com. </p> </div>';
